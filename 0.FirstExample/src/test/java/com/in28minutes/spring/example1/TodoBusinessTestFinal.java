...
@Configuration
@ComponentScan(basePackages = {"com.in28minutes"}) class SpringContext
{
}
...
@Component class TodoBusinessService
{
...
@Component class TodoDataServiceRealImpl implements TodoDataService
{
    public List<String> retrieveTodos(String user)
    {
